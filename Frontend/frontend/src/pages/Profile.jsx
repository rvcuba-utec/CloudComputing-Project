...
export default function Profile() {
  ...
  const loader = useCallback(async () => ({
    profile: await authService.profile(user.id),
    addresses: await authService.addresses(user.id),
    ventas: await ventasService.misVentas(user.id),
  }), [user.id]);
